    ...
    render() {
        return (
            <section className={`${styles.brandOneSection} container`}>
                <Slide responsive={responsiveSettings} cssClass={styles.slider} infinite easing='cubic-out' duration={2500} transitionDuration={1700} arrows={false} autoplay={true} canSwipe={false}>
